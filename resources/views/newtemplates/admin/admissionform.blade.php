	...
	<form method="POST" action="{{route('admin.saveForm')}}" enctype="multipart/form-data">
		...
		<div class="row">
			<!-- <div class="col-md-12 col-lg-12 "> -->
				...
				<div class="col-md-3 col-lg-3 margin1">
	...
	<div class="container">
			<div class="row mb-lg-3 mt-lg-2">
				...
				<div class="col-lg-6">
					...
					<div>
						<input type="text" name="registration_no1" value="smc" readonly class="form-control display" style="width: 20%;" id="reg1">							
				...
				<button class="btn" type="button" onclick="searchReg()"><i class="fa fa-search bg-danger" ></i></button>	
					</div>		
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<div>
						<select class="form-control" name="section_name" required="required">
							@if(old('section_name'))
							<option value="{{old('section_name')}}">{{old('section_name')}}</option>
							@else
							<option value="">--Select</option>
							@endif
			...
			<div class="col-lg-4 text-right">
				<div>
				<img src="{{asset('public/images/user.jpg')}}" title="size 110 x 130" alt="size 110 x 130" style="width: 40%" id="imagePreview">
				<div class="btns">
